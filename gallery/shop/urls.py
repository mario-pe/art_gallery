...
from shop.views.order_view import prepare_no_logged_user_order, make_no_logged_user_order
...
urlpatterns = [
    ...
    url(r"^prepare_no_logged_user_order/$", prepare_no_logged_user_order, name="prepare_no_logged_user_order"),
